...
public class ReutersFetcher : BaseFetcher {
    public ReutersFetcher(SetLabelFunc set_label_func, ClearItemsFunc clear_items_func, AddItemFunc add_item_func) {
    ...
    public override void fetch(string category, string search_query, Soup.Session session) {
        ...
        fetch_google_domain(category, search_query, session, "reuters.com", "Reuters");
    }
